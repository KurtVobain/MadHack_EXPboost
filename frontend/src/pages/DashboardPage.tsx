        ...
        <div className="w-80 flex flex-col gap-6">
          ...
          <Box children = {
            <div className="flex flex-col gap-6">
              ...
              <div className="rounded bg-purple text-center py-2">
                Get Premium
              </div>
            </div>
          }/>
